      ...
      <div class="col-12 col-md-9 col-lg-7 col-xl-6">
        <div class="card" style="border-radius: 15px;">
          ...
          <div class="card-body p-5 pt-3">
            ...
            <form method="post" action="register-script.php" enctype="multipart/form-data" style="font-size: 14px;">
            <?php
              ...
              <label class="form-label" for="form3Example3cg">Password:</label>
                <input style="font-size: 14px;" value = "<?= $password ?>" required type="password" id="form3Example3cg" name="password" class="form-control form-control-lg" />
              </div>

              <div class="form-outline mb-4">
              <label class="form-label" for="form3Example3cg">Repeat Password:</label>
                <input style="font-size: 14px;" value = "<?= $cpassword ?>" required type="password" id="form3Example3cg" name="cpassword" class="form-control form-control-lg" />
              </div>
              ...
              <p class="text-center text-muted mt-5 mb-0">Have an account? <a href="#!"
                  class="fw-bold text-body"><u><a href="signin.php">Login here</a></u></a></p>
